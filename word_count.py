...
#
def mapper(sequence):
    new_sequence = [] #se llama new sequence ya que hay un sequence ya creado
...
#incorpora varias funciones para buscar archivos, valor absoluto, prefijos,
#exist
...
def create_output_directory(output_directory):
    ...
    if os.path.exists(output_directory): #para revisar si existe o no, falso o verdadero
...
# esta funcion falla porque la carpeta output existe, ademas se crea un archivo 
